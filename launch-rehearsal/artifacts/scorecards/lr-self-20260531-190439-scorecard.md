...
| Field | Value |
|-------|--------|
| **Run ID** | `lr-self-20260531-190439` |
| **Date** | 2026-05-31 |
...
| `/agents` | Agents — Launch Rehearsal | 1 | 16 | 0 | 480 |
...
| `/init` | Init wizard — Launch Rehearsal | 1 | 17 | 0 | 288 |
| `/integrations` | Integrations — Launch Rehearsal | 1 | 16 | 0 | 124 |
| `/library` | Journey library — Launch Rehearsal | 1 | 18 | 0 | 164 |
| `/recommendations` | Recommendations — Launch Rehearsal | 1 | 22 | 0 | 227 |
| `/runner` | Runner — Launch Rehearsal | 1 | 17 | 0 | 328 |
...
| `llm-p1-evaluator` | LLM evaluator: First-time evaluator | All journeys function correctly with clear navigation and no errors, providing a |
| `llm-p2-operator` | LLM evaluator: Daily operator | All core journeys complete with no errors, supporting quick and reliable task co |
| `llm-p3-admin` | LLM evaluator: Admin / buyer | Admin can verify access boundaries and trust signals: dashboard loads quickly, n |
| `synthesizer` | Cross-agent synthesis | Synthesized 2 issues, 4 delights from 10 agent reports |
...
| UI/UX | 5 | 0 unlabeled buttons; ~1159ms avg step |
