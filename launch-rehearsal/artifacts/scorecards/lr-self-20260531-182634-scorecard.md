...
| Field | Value |
|-------|--------|
| **Run ID** | `lr-self-20260531-182634` |
| **Date** | 2026-05-31 |
...
| `/agents` | Agents — Launch Rehearsal | 1 | 16 | 0 | 488 |
| `/alerts` | Alerts — Launch Rehearsal | 1 | 16 | 0 | 151 |
| `/cli` | CLI — Launch Rehearsal | 1 | 16 | 0 | 334 |
| `/compare` | Compare runs — Launch Rehearsal | 1 | 18 | 0 | 308 |
| `/config` | Workspace — Launch Rehearsal | 1 | 16 | 0 | 356 |
| `/init` | Init wizard — Launch Rehearsal | 1 | 17 | 0 | 283 |
| `/integrations` | Integrations — Launch Rehearsal | 1 | 16 | 0 | 124 |
| `/library` | Journey library — Launch Rehearsal | 1 | 18 | 0 | 164 |
| `/recommendations` | Recommendations — Launch Rehearsal | 1 | 23 | 0 | 262 |
| `/runner` | Runner — Launch Rehearsal | 1 | 17 | 0 | 302 |
...
| `llm-p1-evaluator` | LLM evaluator: First-time evaluator | Dashboard clearly communicates pre-launch readiness with a prominent score and m |
| `llm-p2-operator` | LLM evaluator: Daily operator | All core journeys (command center, runs, compare, init, runner) load and functio |
| `llm-p3-admin` | LLM evaluator: Admin / buyer | The dashboard is fully functional across device viewports with no errors observe |
...
| UI/UX | 5 | 0 unlabeled buttons; ~1162ms avg step |
...
| **D5** | Clear readiness score at a glance — The command center shows a large '92 · Green' readiness score along with blocker and delight counts, immediately conveying the product's value to a new user. | p1-evaluator | `j1-command-center-p1-evaluator-s1-desktop-seed1-loop1` |
| **D6** | Clear readiness indicator with trend — The command center on mobile shows a readiness score (92/100 green) and a 38-run trend, giving the operator immediate confidence in the system's health. | p2-operator | `j1-command-center-p1-evaluator-s2-mobile-seed1-loop1` |
