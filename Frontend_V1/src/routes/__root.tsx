  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-3 text-sm text-muted-foreground">No journey points here. Head back to the command center.</p>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">A panel failed to render. Try again or head home.</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Observe, analyze, and stage-test the customer-facing surface of any enterprise product before launch." },
      { property: "og:title", content: "Launch Rehearsal — Monitoring" },
      { property: "og:description", content: "Observe, don't modify. Persona × journey, evidence-bound, multi-agent." },
