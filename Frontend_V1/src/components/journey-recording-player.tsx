...
export function JourneyRecordingPlayer({ runId, journeyId }: JourneyRecordingPlayerProps) {
  ...
  const [recording, setRecording] = useState<{ eventCount: number; hasVideo: boolean } | null>(null);
      ...
      {playMode === 'events' && (
        <div className="border border-border rounded-lg p-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm text-muted-foreground">Event replay: {recording.eventCount} interactions captured</span>
          </div>
